...
const WebSocket = require("ws"); // WebSocket-Modul hinzufügen
const { saveLastProject, loadLastProject, combineDrillFilesWithTools, mergeMillingFiles } = require("./ServerScripts");
...
// Optional: Funktion zum Senden an alle verbundenen Clients
